...
(function($) {
	$.fn.askAPI = function(oReq, callbackFunction) {
		var sApiBase = 'http://appstack.io/api/';
				...
				if(oReq.namespace==oNS.composites) {
					if(isStr(oReq.who)) {
						...
						if(typeof(oReq.idComposite)!='undefined') {
							...
							if(typeof(oReq.category)!='undefined') {
								sReqStr += 'category/'+oReq.category+'/';
							} else {
